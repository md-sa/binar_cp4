class TEMPLATE {
        ...
        <div class="col-12 col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <img src="icons/icon_capacity.svg" class="d-inline me-2" alt="Ikon Kapasitas"
                            srcset="">
                        <p class="d-inline">${data.kapasitas} Orang</p>
                    </div>
                    <div class="mb-3">
                        <img src="icons/icon_transmission.svg" class="d-inline me-2" alt="Ikon Kapasitas"
                            srcset="">
                        <p class="d-inline">${data.transmisi}</p>
                    </div>
                    <div class="mb-3">
                        <img src="icons/icon_calender.png" class="d-inline me-2" alt="Ikon Kapasitas"
                            srcset="">
                        <p class="d-inline">${data.tahun}</p>
                    </div>
                    <a href="#" class="btn btn-submit d-block">Pilih Mobil</a>
                </div>
            </div>
        </div>
    `;
  ...
  empty() {
    const html = `<h2>Mohon Maaf Tidak Mobil yang Tersedia</h2>`;
    return html;
  }
}
...
btn.addEventListener("click", () => {
  ...
  if (!valid.includes(false)) {
    ...
    alert("Isi Semua Form untuk Menentukan mobil yang di inginkan");
  }
});
